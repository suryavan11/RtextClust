...
wv = readRDS(...) ## path for word vectors generated by word vector file
class(wv) <- "numeric"
...
########################################################################################
### If you want to change the word embeddings, either use the 'generate word vectors' file to generate a new set of word embeddings or use your own file (correctly formatted) 
